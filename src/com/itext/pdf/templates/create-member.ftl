...
<img src="cid:Easycoop Banner 2.png" alt="https://myeasycoop.com" style="display: block;" />
 <p>Hello ${firstName} ${lastName},</p>
 <p>Your ${comp_name} Staff Cooperative profile on EasyCoop Application has been successfully created.</p> 
 ...
 <p>For assistance, please contact customer service or technical support, 
  please call +2348139840850 - 4 or email: <a href="mailto:polcoop@myeasycoop.com.">polcoop@myeasycoop.com</a></p>
 Thank you.
 <br />
